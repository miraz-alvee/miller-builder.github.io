...
import { SuperintendentSidebar } from "@/components/superintendent/superintendent-sidebar";
...
export default function Layout({ children }: { children: React.ReactNode }) {
  ...
  return (
    <SidebarProvider>
      <SuperintendentSidebar></SuperintendentSidebar>
      <SidebarInset>
        <header
          ...
          <div className="flex items-center gap-2 px-4">
            ...
            <Breadcrumb className="font-semibold text-slate-200 hover:text-slate-100">
              <BreadcrumbList>
                ...
                <BreadcrumbItem>
                  <BreadcrumbPage className="font-semibold text-[#1d1717]">
                    {getPageTitle()}
                  </BreadcrumbPage>
                </BreadcrumbItem>
              </BreadcrumbList>
